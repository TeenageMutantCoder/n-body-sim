...
const About = () => {
    return (
        <div className="About">
            ...
            <ul>
                <li>
                    When I was confused on how to apply the equations, I looked at this interpretation of the simulation:
                    <br />
                    <a href="https://github.com/DennisChunikhin/Orbit-Lab" rel="noopener noreferrer" target="_blank">https://github.com/DennisChunikhin/Orbit-Lab</a>
                </li>
                <li>
                    If you want a more detailed explanation, this is a great article by someone who did a more in-depth simulation of the solar system using similar math:
                    <br />
                    <a href="https://compphys.go.ro/newtonian-gravity/" rel="noopener noreferrer" target="_blank">https://compphys.go.ro/newtonian-gravity/</a>
                </li>
                <li>
                    This is how I learned about Kepler's laws and discovered the relevance of Newton's law of gravitation:
                    <br />
                    <a href="https://en.wikipedia.org/wiki/Kepler%27s_laws_of_planetary_motion#Newton's_law_of_gravitation" rel="noopener noreferrer" target="_blank">https://en.wikipedia.org/wiki/Kepler%27s_laws_of_planetary_motion#Position_as_a_function_of_time</a>
                </li>
                <li>
                    This equation (and the one in the section after) is essentially what I used:
                    <br />
                    <a href="https://en.wikipedia.org/wiki/Newton%27s_law_of_universal_gravitation#Vector_form" rel="noopener noreferrer" target="_blank">https://en.wikipedia.org/wiki/Newton%27s_law_of_universal_gravitation#Vector_form</a>
                </li>
                <li>
                    To learn about N-body simulations and find a solution to one of my problems, I went here:
                    <br />
                    <a href="https://en.wikipedia.org/wiki/N-body_simulation#Softening" rel="noopener noreferrer" target="_blank">https://en.wikipedia.org/wiki/N-body_simulation#Softening</a>
                </li>
            </ul>
        </div>
    );
